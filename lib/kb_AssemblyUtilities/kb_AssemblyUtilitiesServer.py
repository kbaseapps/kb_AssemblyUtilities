...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'kb_AssemblyUtilities'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from kb_AssemblyUtilities.kb_AssemblyUtilitiesImpl import kb_AssemblyUtilities  # noqa @IgnorePep8
impl_kb_AssemblyUtilities = kb_AssemblyUtilities(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'kb_AssemblyUtilities'
